...
package com.liubocoding.pagedgallery;
...
/**
 * @author liubocoding@gmail.com<br />
 * @since
 * 
 *        A view that shows items in a center-locked, paged scrolling list.
 * 
 * @attr ref android.R.styleable#Gallery_animationDuration
 * @attr ref android.R.styleable#Gallery_spacing
 * @attr ref android.R.styleable#Gallery_gravity
 */
public class PagedGallery extends AbsSpinner implements GestureDetector.OnGestureListener {

    private static final String TAG = "PagedGallery";
    ...
    /**
     * 记录用户屏幕滚动滚动中的总距离，用于touchUp时判定滚动方向<br/>
     * dis =TouchUp.x - TouchDown.x;
     */
    int mTotalScrollDis = 0;
    ...
    public PagedGallery(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        ...
        //
        // // Fling the gallery!
        // mFlingRunnable.startUsingVelocity((int) -(velocityX * 0.5f));
    ...
    void onUp() {
        ...
        if (mTotalScrollDis > 30) {
            int newPos = mSelectedPosition + 1;
            if (newPos > mAdapter.getCount() - 1) {
                newPos = mAdapter.getCount() - 1;
            }
            setSelectedPositionInt(newPos);
            setNextSelectedPositionInt(newPos);
            checkSelectionChanged();
